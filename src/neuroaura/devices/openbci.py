...
or the neuroaura real-time pipeline can subscribe to.

Requirements
------------
    pip install "neuroaura[openbci]"   # installs brainflow
    ...
    def connect(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install 'neuroaura[openbci,realtime]'"
            ) from exc
